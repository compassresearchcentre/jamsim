JAMSIM is a framework for creating microsimulation models in Java. It provides code and packages for common [features](Features.md) of microsimulation models for end users.
